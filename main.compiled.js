...
var author$project$Main$Model = F6(
	function (initialRoom, currentRoom, items, allRooms, commandText, history) {
		return {allRooms: allRooms, commandText: commandText, currentRoom: currentRoom, history: history, initialRoom: initialRoom, items: items};
	});
var author$project$Main$NavigationTarget = F2(
	function (direction, roomId) {
		return {direction: direction, roomId: roomId};
	});
var author$project$Main$Right = {$: 'Right'};
var author$project$Main$Room = F5(
	function (id, description, navigation, commands, items) {
		return {commands: commands, description: description, id: id, items: items, navigation: navigation};
	});
var author$project$Main$Up = {$: 'Up'};
var author$project$Main$HistoryEntry = function (a) {
	return {$: 'HistoryEntry', a: a};
};
var author$project$Main$PlainText = function (a) {
...
var author$project$Main$addHistory = F2(
			...
			model,
			{
				history: A2(
					...
					author$project$Main$HistoryEntry(
						_List_fromArray(
							[
								author$project$Main$PlainText(entry)
							])),
					model.history)
			});
	});
...
var author$project$Main$pencil = A2(author$project$Main$Item, 'pencil', 'Pencil');
var author$project$Main$LightGreen = {$: 'LightGreen'};
var author$project$Main$ColoredText = function (a) {
	return {$: 'ColoredText', a: a};
};
var author$project$Main$addColoredHistory = F3(
	function (color, text, model) {
		return _Utils_update(
			model,
			{
				history: A2(
					...
					author$project$Main$HistoryEntry(
						_List_fromArray(
							[
								author$project$Main$ColoredText(
								_Utils_Tuple2(color, text))
							])),
					model.history)
			});
	});
var elm$core$Basics$append = _Utils_append;
var author$project$Main$showItem = function (item) {
	return 'There is a ' + (item.name + ' on the ground.');
};
var author$project$Main$addItemTohistory = F2(
	function (model, item) {
		return A3(
			author$project$Main$addColoredHistory,
			author$project$Main$LightGreen,
			author$project$Main$showItem(item),
			model);
	});
var author$project$Main$addItemsToHistory = F2(
	function (items, model) {
		...
		while (true) {
			if (!items.b) {
				...
				var h = items.a;
				var t = items.b;
				var newModel = A2(author$project$Main$addItemTohistory, model, h);
				var $temp$items = t,
					$temp$model = newModel;
				items = $temp$items;
				model = $temp$model;
				continue addItemsToHistory;
			}
		}
	});
...
var author$project$Main$addLinksToHistory = function (model) {
	var entry = function () {
		var _n0 = model.currentRoom.navigation;
		if (_n0.b) {
			return author$project$Main$HistoryEntry(
				A2(
					elm$core$List$append,
					_List_fromArray(
						[
							author$project$Main$PlainText('You can go ')
						]),
					A2(
						...
						A2(
							elm$core$List$map,
							function (dir) {
								return author$project$Main$ColoredText(
									_Utils_Tuple2(
										author$project$Main$Red,
										author$project$Main$directionToString(dir.direction)));
							},
							model.currentRoom.navigation))));
		} else {
			return author$project$Main$HistoryEntry(
				_List_fromArray(
					[
						author$project$Main$PlainText('There\'s nowhere to go')
					]));
		}
	}();
	return _Utils_update(
		model,
		{
			history: A2(elm$core$List$cons, entry, model.history)
		});
};
var author$project$Main$showNavigated = function (model) {
	return author$project$Main$addLinksToHistory(
		A2(
			author$project$Main$addItemsToHistory,
			model.currentRoom.items,
			A2(author$project$Main$addHistory, model.currentRoom.description, model)));
};
var author$project$Main$welcomeText = '\r\n*******************************************************************\r\nWelcome to Simon Gustavsson\'s website.\r\n--------------------------------------\r\nHere you can interactively navigate around the mysterious mind that is Simon\'s,\r\nand get a better idea of who he is, and what he\'s been up to.\r\n*******************************************************************\r\n';
...
var author$project$Main$init = function (_n0) {
	var kitchen = A5(
		...
		'Kitchen',
		'You go left through a rickety door and find yourself in a dingy old kitchen.',
		_List_fromArray(
			[
				A2(author$project$Main$NavigationTarget, author$project$Main$Right, 'Basement'),
				A2(author$project$Main$NavigationTarget, author$project$Main$Down, 'Home')
			]),
		_List_Nil,
		_List_Nil);
	var firstRoom = A5(
		author$project$Main$Room,
		'Home',
		'You find yourself in the woods. There\'s a big suspicious looking hole in the ground.',
		_List_fromArray(
			[
				A2(author$project$Main$NavigationTarget, author$project$Main$Down, 'Basement')
			]),
		_List_Nil,
		_List_fromArray(
			[author$project$Main$pencil]));
	var basement = A5(
		author$project$Main$Room,
		'Basement',
		'You\'ve entered a basement. You immediately spot a strange corner to the left...',
		_List_fromArray(
			[
				A2(author$project$Main$NavigationTarget, author$project$Main$Up, 'Home'),
				A2(author$project$Main$NavigationTarget, author$project$Main$Left, 'Kitchen')
			]),
		_List_Nil,
		_List_Nil);
	var initialModel = author$project$Main$showNavigated(
		A2(
			author$project$Main$addHistory,
			'',
			A2(
				author$project$Main$addHistory,
				author$project$Main$welcomeText,
				A6(
...
var author$project$Main$StringCommand = function (a) {
	return {$: 'StringCommand', a: a};
};
var author$project$Main$dropCommand = author$project$Main$StringCommand('drop');
var author$project$Main$helpCommand = author$project$Main$StringCommand('help');
var author$project$Main$inventoryCommand = author$project$Main$StringCommand('inventory');
var author$project$Main$lookCommand = author$project$Main$StringCommand('look');
var author$project$Main$takeCommand = author$project$Main$StringCommand('take');
var author$project$Main$alwaysAvailableCommands = _List_fromArray(
	[author$project$Main$inventoryCommand, author$project$Main$takeCommand, author$project$Main$dropCommand, author$project$Main$helpCommand, author$project$Main$lookCommand]);
var author$project$Main$addItemToRoom = F2(
	function (room, item) {
		return _Utils_update(
			room,
			{
				items: A2(elm$core$List$cons, item, room.items)
			});
	});
...
var author$project$Main$dropItemInRoom = F2(
	function (model, itemName) {
		var _n0 = A2(
			elm_community$list_extra$List$Extra$find,
			function (item) {
				return _Utils_eq(
					elm$core$String$toUpper(item.name),
					elm$core$String$toUpper(itemName));
			},
			model.items);
		if (_n0.$ === 'Just') {
			var itemToDrop = _n0.a;
			var newInventory = A2(
				elm$core$List$filter,
				function (item) {
					return !_Utils_eq(item.id, itemToDrop.id);
				},
				model.items);
			var currentWithItem = A2(author$project$Main$addItemToRoom, model.currentRoom, itemToDrop);
			var allRoomWithoutRoom = A2(
				elm$core$List$filter,
				function (room) {
					return !_Utils_eq(room.id, model.currentRoom.id);
				},
				model.allRooms);
			var allRoomsWithItem = A2(elm$core$List$cons, currentWithItem, allRoomWithoutRoom);
			return A2(
				author$project$Main$addHistory,
				'You throw a ' + (itemToDrop.name + ' on the ground.'),
				_Utils_update(
					model,
					{allRooms: allRoomsWithItem, currentRoom: currentWithItem, items: newInventory}));
		} else {
			return A2(author$project$Main$addHistory, 'You\'re not carrying an item with that name', model);
		}
	});
var author$project$Main$findItemInRoom = F2(
	function (room, itemName) {
		return A2(
			elm_community$list_extra$List$Extra$find,
			function (item) {
				return _Utils_eq(
...
var author$project$Main$removeItemFromRoom = F2(
	function (room, itemToRemove) {
		var itemsWithoutItem = A2(
			elm$core$List$filter,
			function (item) {
				return !_Utils_eq(item.id, itemToRemove.id);
			},
			room.items);
		return _Utils_update(
			room,
...
var author$project$Main$pickupItemFromRoom = F2(
	function (model, itemName) {
		var _n0 = model.currentRoom.items;
		if (!_n0.b) {
			return A2(author$project$Main$addHistory, 'There\'s nothing to take in this room!', model);
		} else {
			var _n1 = A2(author$project$Main$findItemInRoom, model.currentRoom, itemName);
			if (_n1.$ === 'Just') {
				var item = _n1.a;
				var roomWithoutItem = A2(author$project$Main$removeItemFromRoom, model.currentRoom, item);
				var allRoomsWithoutRoom = A2(
					elm$core$List$filter,
					function (room) {
						return !_Utils_eq(room.id, model.currentRoom.id);
					},
					model.allRooms);
				var allRoomsWithoutItem = A2(elm$core$List$cons, roomWithoutItem, allRoomsWithoutRoom);
				return A2(
					author$project$Main$addHistory,
					...
					_Utils_update(
						model,
						{
							allRooms: allRoomsWithoutItem,
							currentRoom: roomWithoutItem,
							items: A2(elm$core$List$cons, item, model.items)
						}));
			} else {
				return A2(author$project$Main$addHistory, 'There\'s no item \'' + (itemName + '\' here.'), model);
			}
		}
	});
var author$project$Main$showHelp = function (model) {
	return A2(author$project$Main$addHistory, '\r\n*******************************************************************\r\nWelcome traveler 3468.\r\n--------------------------------\r\nhelp               - Shows this help\r\nup/down/left/right - Navigate around in the world.\r\ntake {item}        - Picks up an item you find in a room, e.g. \'take pencil\'.\r\ndrop {item}        - Drops an item in the current room.\r\ninventory          - Shows all items you\'re currently carrying.\r\ntime               - Shows the current time and the last time the world went through a magic shift.\r\nlook               - Look around the room.\r\n\r\nProtocol 5 until further notice.\r\n*******************************************************************\r\n    ', model);
};
var author$project$Main$showInventory = function (model) {
	var showCore = F2(
		function (remaining, m) {
			showCore:
			while (true) {
				if (remaining.b) {
					var nextItem = remaining.a;
					var newRemaining = remaining.b;
					var $temp$remaining = newRemaining,
						$temp$m = A2(author$project$Main$addHistory, '* ' + nextItem.name, m);
	...
	if (_n1.b) {
		return A2(
			showCore,
			model.items,
			A2(author$project$Main$addHistory, 'You are carrying: ', model));
	} else {
		return A2(author$project$Main$addHistory, 'You\'re not carrying anything.', model);
	}
};
var author$project$Main$showTime = function (model) {
	return A2(author$project$Main$addHistory, 'Time in Elm is tricky, watch this space..', model);
};
var author$project$Main$executeCommand = F3(
	function (model, command, args) {
		var commandName = command.a;
		switch (commandName) {
			case 'help':
				return author$project$Main$showHelp(model);
			case 'inventory':
				return author$project$Main$showInventory(model);
			case 'take':
				if (args.b) {
					var firstArg = args.a;
					return A2(author$project$Main$pickupItemFromRoom, model, firstArg);
				} else {
					return A2(author$project$Main$addHistory, 'Take what exactly?', model);
				}
			case 'drop':
				if (args.b) {
					var firstArg = args.a;
					return A2(author$project$Main$dropItemInRoom, model, firstArg);
				} else {
					return A2(author$project$Main$addHistory, 'What do you want to drop?', model);
				}
			case 'look':
				return author$project$Main$showNavigated(model);
			case 'time':
				return author$project$Main$showTime(model);
			default:
				return A2(author$project$Main$addHistory, 'I don\'t know what that is (yet?).', model);
		}
	});
var author$project$Main$navigate = F2(
	function (model, direction) {
		var directionString = author$project$Main$directionToString(direction);
		var _n0 = A2(
			elm_community$list_extra$List$Extra$find,
			function (nav) {
				return _Utils_eq(nav.direction, direction);
			},
			model.currentRoom.navigation);
		if (_n0.$ === 'Just') {
			var targetRoom = _n0.a;
			var _n1 = A2(
				elm_community$list_extra$List$Extra$find,
				function (room) {
					return _Utils_eq(room.id, targetRoom.roomId);
				},
				model.allRooms);
			if (_n1.$ === 'Just') {
				var room = _n1.a;
				return author$project$Main$showNavigated(
					_Utils_update(
						model,
						{currentRoom: room}));
			} else {
				return A2(author$project$Main$addHistory, 'Hmm, can\'t seem to be able to reach that room...', model);
			}
		} else {
			return A2(author$project$Main$addHistory, 'You cannot go ' + directionString, model);
		}
	});
var author$project$Main$parseCommand = F2(
	function (string, availableCommands) {
		var split = A2(elm$core$String$split, ' ', string);
		if (split.b) {
			var h = split.a;
			var args = split.b;
			var _n1 = A2(
				elm_community$list_extra$List$Extra$find,
				function (command) {
					var commandAlias = command.a;
					return _Utils_eq(
						elm$core$String$toUpper(commandAlias),
...
var author$project$Main$stringToDirection = function (string) {
	switch (string) {
		case 'left':
			return elm$core$Maybe$Just(author$project$Main$Left);
		case 'right':
			return elm$core$Maybe$Just(author$project$Main$Right);
		case 'up':
			return elm$core$Maybe$Just(author$project$Main$Up);
		case 'down':
...
var author$project$Main$handleCommand = F2(
	function (rawCommandString, model) {
		var availableCommands = A2(elm$core$List$append, author$project$Main$alwaysAvailableCommands, model.currentRoom.commands);
		var _n0 = author$project$Main$stringToDirection(rawCommandString);
		if (_n0.$ === 'Just') {
			var direction = _n0.a;
			return A2(author$project$Main$navigate, model, direction);
		} else {
			var _n1 = A2(author$project$Main$parseCommand, rawCommandString, availableCommands);
			if (_n1.$ === 'Just') {
				var _n2 = _n1.a;
				var command = _n2.a;
				var args = _n2.b;
				return A3(author$project$Main$executeCommand, model, command, args);
			} else {
				return A2(author$project$Main$addHistory, 'I\'m sorry, Dave. I\'m afraid I can\'t do that.', model);
			}
		}
	});
			...
			case 'NewCommand':
				var scrollCommand = A2(
					...
					A2(
						elm$core$Task$andThen,
						function (info) {
							return A3(elm$browser$Browser$Dom$setViewportOf, 'room', 0, info.scene.height);
						},
						elm$browser$Browser$Dom$getViewportOf('room')));
				var modelAfterCommand = A2(
					author$project$Main$handleCommand,
					model.commandText,
					A3(author$project$Main$addColoredHistory, author$project$Main$Green, '> ' + model.commandText, model));
				return _Utils_Tuple2(
					_Utils_update(
						modelAfterCommand,
						{commandText: ''}),
...
var author$project$Main$viewEntry = function (_n0) {
	var parts = _n0.a;
	var coreEntryStyle = _List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'margin', '0'),
			A2(elm$html$Html$Attributes$style, 'white-space', 'pre-wrap'),
			A2(elm$html$Html$Attributes$style, 'font-family', '\'Courier New\', Courier, monospace')
		]);
	var viewCoreEntry = function (coreEntry) {
		if (coreEntry.$ === 'PlainText') {
			var str = coreEntry.a;
			return _List_fromArray(
				[
					A2(
			...
			var color = _n2.a;
			var str = _n2.b;
			var colorAttribute = function () {
				switch (color.$) {
					case 'Red':
						return A2(elm$html$Html$Attributes$style, 'color', 'red');
					case 'Green':
						return A2(elm$html$Html$Attributes$style, 'color', 'green');
					default:
						return A2(elm$html$Html$Attributes$style, 'color', 'rgb(159, 232, 158)');
				}
			}();
			return _List_fromArray(
				[
					A2(
					elm$html$Html$pre,
					A2(elm$core$List$cons, colorAttribute, coreEntryStyle),
					_List_fromArray(
						[
							elm$html$Html$text(str)
						]))
	...
	return _List_fromArray(
		[
			...
			elm$core$List$concat(
				A2(elm$core$List$map, viewCoreEntry, parts)))
		]);
};
...
var author$project$Main$CommandTextChanged = function (a) {
	return {$: 'CommandTextChanged', a: a};
};
var author$project$Main$NewCommand = {$: 'NewCommand'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onSubmit(author$project$Main$NewCommand)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Main$CommandTextChanged),
								elm$html$Html$Attributes$placeholder('Type your next command here. Try \'help\' to see what you can do!'),
								elm$html$Html$Attributes$value(model.commandText),
								A2(elm$html$Html$Attributes$style, 'width', '100%'),
								...
								A2(elm$html$Html$Attributes$style, 'color', '#02f100'),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('switch-notice')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$text('MUDs are sooo 1980\'s.')
								])),
							A2(
							elm$html$Html$a,
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('#visual')
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Take me to the real site')
								]))
						])),
					A2(
					elm$html$Html$div,
					...
					author$project$Main$viewHistory(model.history)),
...
var author$project$Main$viewSite = function (model) {
	return A2(
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		view: author$project$Main$viewSite
	});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Message","aliases":{},"unions":{"Main.Message":{"args":[],"tags":{"NoOp":[],"NewCommand":[],"CommandTextChanged":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));