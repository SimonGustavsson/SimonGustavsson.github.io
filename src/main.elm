...
viewSite : Model -> Document Message
viewSite model =
    Document "Simon Gustavsson" (view model)
...
view model =
    [ div
        ...
        [ div [ class "switch-notice" ] [ span [] [ text "MUDs are sooo 1980's." ], a [ href "#visual" ] [ text "Take me to the real site" ] ]
        , div
            [ id "room"
            , style "height" "100%"
            , style "display" "flex"
